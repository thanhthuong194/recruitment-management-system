...
public class RegisterUser201Response {
   ...
   */
  public RegisterUser201Response(Boolean success, Object data) {
    this.success = success;
    this.data = data;
  }

  public RegisterUser201Response success(Boolean success) {
    this.success = success;
    return this;
  }
  ...
  public RegisterUser201Response data(Object data) {
    this.data = data;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "data", description = "The created resource data", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("data")
