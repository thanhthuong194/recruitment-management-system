...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecruitmentManagementSystemApi.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new RecruitmentManagementSystemApi.ErrorResponse();
      //expect(instance).to.be.a(RecruitmentManagementSystemApi.ErrorResponse);
    });
