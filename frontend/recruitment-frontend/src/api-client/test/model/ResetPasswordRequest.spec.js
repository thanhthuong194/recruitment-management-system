...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecruitmentManagementSystemApi.ResetPasswordRequest();
  });
  ...
  describe('ResetPasswordRequest', function() {
    it('should create an instance of ResetPasswordRequest', function() {
      ...
      //var instance = new RecruitmentManagementSystemApi.ResetPasswordRequest();
      //expect(instance).to.be.a(RecruitmentManagementSystemApi.ResetPasswordRequest);
    });
