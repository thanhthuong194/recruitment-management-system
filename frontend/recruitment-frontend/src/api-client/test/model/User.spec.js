...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecruitmentManagementSystemApi.User();
  });
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instance = new RecruitmentManagementSystemApi.User();
      //expect(instance).to.be.a(RecruitmentManagementSystemApi.User);
    });
