...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecruitmentManagementSystemApi.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new RecruitmentManagementSystemApi.ErrorDetail();
      //expect(instance).to.be.a(RecruitmentManagementSystemApi.ErrorDetail);
    });
